...
You can can either go into the Support forum, or in the [Robocrop Repository](https://github.com//robocrop).

= I'd like to suggest a feature. Where should I post it? =

I personally prefer GitHub. The plugin code is here: [GitHub](https://github.com//robocrop)
(See above as well.)
...
3. type `git clone git@github.com:/robocrop.git`
...
Either post it on the [GitHub-repo](https://github.com//robocrop) or—if you cloned the repository—send me a pull request.
