...
?>
	<script type="text/html" id="tmpl-robocrop-modal">
		<div class="media-modal robocrop-modal wp-core-ui">
			<button type="button" class="media-modal-prev"><span class="dashicons dashicons-arrow-left-alt2"><span class="screen-reader-text"><?php _e('Previous'); ?></span></span></button>
			<button type="button" class="media-modal-next"><span class="dashicons dashicons-arrow-right-alt2"><span class="screen-reader-text"><?php _e('Next'); ?></span></span></button>
