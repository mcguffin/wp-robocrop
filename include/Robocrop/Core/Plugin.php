...
class Plugin extends PluginComponent {
	...
	private static $components = array(
		'Robocrop\Settings\SettingsMedia',
	);
	...
	protected function __construct( $file ) {
		...
		register_uninstall_hook( $this->get_plugin_file(), array( __CLASS__, 'static_uninstall' ) );
	...
	public function get_asset_url( $asset ) {
		return plugins_url( $asset, $this->get_wp_plugin() );
	}
	...
	public function get_asset_path( $asset ) {
		return $this->get_plugin_dir() . $asset;
	}
	...
	public function maybe_upgrade() {
		...
		$old_version = get_site_option( 'robocrop_version' );
		...
		if ( version_compare($new_version, $old_version, '>' ) ) {
			...
			update_site_option( 'robocrop_version', $new_version );
