...
q={bindHandlers:function(){this._parentBindHandlers.apply(this,arguments);this.on("content:create:robocrop-image",this.robocropImageMode,this);this.on("content:render:robocrop-image",this.robocropImageModeRender,this)},robocropImageMode:function(a){var e=new b.media.robocrop.controller.RobocropImage({model:m,frame:this,content:this.content});e._toolbar=function(){};e._router=function(){};e._menu=function(){};a.view=new b.media.robocrop.view.RobocropImage({model:m,frame:this,controller:this.controller})},
robocropImageModeRenderer:function(a){a.on("ready",a.loadEditor)}};_.extend(b.media.view.MediaFrame.EditAttachments.prototype,{_parentBindHandlers:b.media.view.MediaFrame.EditAttachments.prototype.bindHandlers},q);_.extend(b.media.view.MediaFrame.Post.prototype,{_parentBindHandlers:b.media.view.MediaFrame.Post.prototype.bindHandlers,_parentCreateStates:b.media.view.MediaFrame.Post.prototype.createStates},q,p);_.extend(b.media.view.ImageDetails.prototype,{_parentPostRender:b.media.view.ImageDetails.prototype.postRender,
postRender:function(){this._parentPostRender.apply(this,arguments);this.$el.find(".actions").append(r)},robocropAttachment:function(a){var b=this.controller.states.get("robocrop-image");m=this.controller.image.attachment;k=null;n=this.controller;l=this.controller.state();b&&(a.preventDefault(),this.controller.setState("robocrop-image"))}});b.media.view.ImageDetails.prototype.events["click .robocrop-attachment"]="robocropAttachment";_.extend(b.media.view.MediaFrame.ImageDetails.prototype,{_parentBindHandlers:b.media.view.MediaFrame.ImageDetails.prototype.bindHandlers,
_parentCreateStates:b.media.view.MediaFrame.ImageDetails.prototype.createStates},q,p);_.extend(b.media.view.Attachment.Details.prototype,{_parentRender:b.media.view.Attachment.Details.prototype.render,render:function(){this._parentRender.apply(this,arguments);this.$(".attachment-actions").append(r);f(u).insertAfter(this.$el.find("a.edit-attachment"))},robocropAttachment:function(a){var b=this.controller.states.get("robocrop-image");m=this.model;n=this.controller;b?(k=null,l=this.controller.state(),
a.preventDefault(),this.controller.setState("robocrop-image")):(k=this.controller.content.mode(),l=null,this.controller.content.mode("robocrop-image"))},_parentCreateStates:b.media.view.Attachment.Details.prototype.createStates},p);b.media.view.Attachment.Details.prototype.events["click .robocrop-attachment"]="robocropAttachment";b.media.robocrop.view.Img=b.media.View.extend({className:"attachment-image",tagName:"img",id:"robocrop-image",initialize:function(){_.defaults(this.options,{src:""});this.$el.attr("src",
this.options.src)},getSrc:function(a){return this.$el.attr("src")},setSrc:function(a){a&&this.$el.attr("src",a);return this}});b.media.robocrop.view.RobocropRatioSelect=b.media.View.extend({className:"robocrop-select",template:b.template("robocrop-select"),events:{'click [name="robocrop-select-ratio"]':"selectRatio"},initialize:function(){b.Backbone.View.prototype.initialize.apply(this,arguments);_.defaults({ratios:{},tools:{}},this.options);this.options.l10n=g},render:function(){b.Backbone.View.prototype.render.apply(this,
arguments);var a=this;_.each(this.options.tools,function(e,c){a.views.add(new b.media.robocrop.view.RobocropRatioSelectItem({ratiokey:c,sizenames:!1,ratio:c,title:e.title,enabled:!0}))});_.each(this.options.ratios,function(e,c){var d=[],g=_.template('<span class="sizename<%= cancrop ? "" : " disabled" %>"><%= name %> (<%= width %>\u00d7<%= height %>)</span>');_.each(e.sizes,function(b,e){var c=f.extend(!0,{cancrop:a.model.get("width")>=h[b].width&&a.model.get("height")>=h[b].height},h[b]);c.crop&&
d.push(g(c))});a.views.add(new b.media.robocrop.view.RobocropRatioSelectItem({ratiokey:c,sizenames:d.join(""),ratio:c,title:c+" : 1",enabled:a.model.get("width")>=e.min_width&&a.model.get("height")>=e.min_height}))})},setSelected:function(a){this.$el.find('[name="robocrop-select-ratio"][value="'+a+'"]').prop("checked",!0);this.selectRatio()},getSelected:function(){return this.$el.find('[name="robocrop-select-ratio"]:checked').val()},selectRatio:function(a){this.options.ratios[this.getSelected()]?
...
this))&&(a=e.name);a||(a="focuspoint");this.selectRatio.setSelected("focuspoint");return this},save:function(){var a={attachments:{}},b=this.model.get("id"),c=this.$saveButton.add(this.$cancelButton).add(this.$autoButton).prop("disabled",!0),d=this;a.attachments[b]={sizes:this.model.get("sizes"),focuspoint:this.model.get("focuspoint")};this.model.saveCompat(a,{}).done(function(a){var b=new Date;_.each(d.model.attributes.sizes,function(a,e){"full"!==e&&f(document).add(f("iframe").contents()).find('img[src^="'+
a.url+'"]').each(function(){f(this).attr("src",a.url+"?"+b.getTime())})},d);c.prop("disabled",!1)});return this},cancel:function(){k?n.content.mode(k):l&&n.setState(l);return this},onselecttool:function(){var a=this.selectRatio.getSelected();this.$areaSelect().cancelSelection();switch(a){case "focuspoint":this.focuspointtool.setEnabled(!0)}},onselectratio:function(){this.focuspointtool.setEnabled(!1);var a=this.selectRatio.getSelected(),b=this.model.get("sizes"),c,d,g=this,f,k=this.model.get("width"),
l=this.model.get("height");this.current_ratio=this.image_ratios[a];f={aspectRatio:this.current_ratio.ratio+":1",minWidth:this.current_ratio.min_width,minHeight:this.current_ratio.min_height};_.each(this.current_ratio.sizes,function(a){!d&&b[a]&&b[a].cropdata&&(d=b[a].cropdata);h[a].width<=k&&h[a].height<=l&&(f.minWidth=Math.max(f.minWidth,h[a].width),f.minHeight=Math.max(f.minHeight,h[a].height))});d?(c={},_.extend(c,d)):(a=Math.min(this.model.get("width")/this.current_ratio.ratio,this.model.get("height")),
c={x:0,y:0,width:a*this.current_ratio.ratio,height:a},c.x=(this.model.get("width")-c.width)/2,c.y=(this.model.get("height")-c.height)/2);this.$areaSelect().setOptions(f);if(this.image.$el.get(0).complete)this.selectCrop(c);else this.image.$el.on("load",function(){g.selectCrop(c)});return this},autocrop:function(a){var e={width:this.model.get("width"),height:this.model.get("height"),focuspoint:this.model.get("focuspoint")};a=b.media.robocrop.cropFromFocusPoint(e,this.current_ratio);a=b.media.robocrop.relToAbsCoords(a,
e);this._setCropSizes(a);this.selectCrop(a);return this},selectCrop:function(a){this._image_scale_factor();a=b.media.robocrop.rectToPointCoords(a);var e=this.$areaSelect();e.setSelection(a.x1,a.y1,a.x2,a.y2,!1);e.setOptions({show:!0});e.update();return this},$areaSelect:function(){return f("#robocrop-image").data("imgAreaSelect")},_image_scale_factor:function(){var a=this.image.$el.closest(".robocrop-image-box"),b=Math.min(this.model.get("width"),a.width()),a=Math.min(this.model.get("height"),a.height());
...
"toolbar:render:robocrop-image",this.toolbar)},deactivate:function(){this.stopListening(this.frame)}})})(wp,jQuery);
(function(h){var f=window.wp_robocrop.image_ratios,n=h.media.view.UploaderWindow.prototype.ready,p=!1,m={};window.wp_robocrop.options.ask_for_focuspoint&&(h.media.view.UploaderWindow.prototype.ready=function(){function h(q){var b;a&&a.close().dispose();l.length?(b=l.shift(),a=new wp.media.robocrop.view.focuspoint.AskFocuspoint({modal:!0}),a.on("proceed",function(){m[b.file.name]={focuspoint:a.getFocuspoint(),width:a.getImageWidth(),height:a.getImageHeight()};h(q)}).on("cancel-upload",function(){b.file.attachment.destroy()}),
a.setFocuspoint({x:0,y:0}),b.dataUrl?a.setSrc(b.dataUrl):a.setFile(b.blob),a.open()):q.start()}var l=[],a;if(p)return n.apply(this,arguments);p=!0;ret=n.apply(this,arguments);this.uploader.uploader.bind("FilesAdded",function(a,b){a.stop();a.refresh();for(var c=0;c<b.length;c++)if("image/png"==b[c].type||"image/jpeg"==b[c].type){var d=b[c],e={file:d,blob:d.getNative(),dataUrl:!1},g=void 0,f=void 0,k=void 0;e.blob||(e.blob=d.getSource());if(e.blob.getSource&&(g=e.blob.getSource(),"string"===typeof g)){e.dataUrl=
"data:"+d.type+";base64,"+btoa(g);f=new Uint8Array(g.length);for(k=0;k<g.length;k++)f[k]=g.charCodeAt(k);e.blob=new Blob(f,{type:e.file.type})}(fileData=e)&&l.push(fileData)}l.length?h(a):a.start()});this.uploader.uploader.bind("BeforeUpload",function(a,b){var c,d;if(m[b.name]){imageinfo=m[b.name];d={};for(c in f)d[f[c].name]=wp.media.robocrop.cropFromFocusPoint(imageinfo,f[c]);a.settings.multipart_params.focuspoint=JSON.stringify(imageinfo.focuspoint);a.settings.multipart_params.cropdata=JSON.stringify(d)}});
return ret})})(wp);
